...
public class TestUtil {
    ...
    private static Task[] getSamplePersonData() {
        try {
            return new Task[]{
                new Task(new Name("Ali Muster"), new Phone("9482424"), new UniqueTagList()),
                new Task(new Name("Boris Mueller"), new Phone("87249245"), new UniqueTagList()),
                new Task(new Name("Carl Kurz"), new Phone("95352563"), new UniqueTagList()),
                new Task(new Name("Daniel Meier"), new Phone("87652533"), new UniqueTagList()),
                new Task(new Name("Elle Meyer"), new Phone("9482224"), new UniqueTagList()),
                new Task(new Name("Fiona Kunz"), new Phone("9482427"), new UniqueTagList()),
                new Task(new Name("George Best"), new Phone("9482442"), new UniqueTagList()),
                new Task(new Name("Hoon Meier"), new Phone("8482424"), new UniqueTagList()),
                new Task(new Name("Ida Mueller"), new Phone("8482131"), new UniqueTagList())
            };
