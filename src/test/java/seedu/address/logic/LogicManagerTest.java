...
public class LogicManagerTest {
    ...
    public void execute_add_invalidPersonData() throws Exception {
        assertCommandBehavior(
                "add []\\[;] p/12345", Name.MESSAGE_NAME_CONSTRAINTS);
        assertCommandBehavior(
                "add Valid Name p/not_numbers", Phone.MESSAGE_PHONE_CONSTRAINTS);
        assertCommandBehavior(
                "add Valid Name p/12345 t/invalid_-[.tag", Tag.MESSAGE_TAG_CONSTRAINTS);
    ...
    class TestDataHelper {
        ...
        Task adam() throws Exception {
            ...
            return new Task(name, privatePhone, tags);
        }
